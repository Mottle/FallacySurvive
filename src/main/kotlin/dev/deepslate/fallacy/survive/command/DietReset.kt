...
object DietReset : GameCommand {
    override val source: String = "fallacy diet reset %s<name>"
    ...
    override val permissionRequired: String = "fallacy_survive.command.diet.reset"
    ...
    override fun execute(context: CommandContext<CommandSourceStack>): Int {
        ...
        diet.nutrition = LivingEntityNutritionState.DEFAULT
